...
%чтобы найти соединение частей речи в оборотах(возможно надо будет переписать дл€ каждой части речи с отсечением (а нет, не понадобилось :)))) )
...
******************************************************************************/
	...
	verb(["был"| X], X, 2,3).
	verb(["был"| X], X, 2,3).
	verb(["выгл€дел"| X], X, 2,3).
	verb(["смотрелс€"| X], X, 2,3).
	...
	participle(["смотр€щий"| X], X,1,0,1).
	%ƒ≈≈ѕ–»„ј—“»я
	gerund(["смотр€"| X], X).
		
%Ћ»„Ќџ≈ ћ≈—“ќ»ћ≈Ќ»я - ѕ–ј¬»Ћќ mest, ќ—“јЋ№Ќџ≈ ћ≈—“ќ»ћ≈Ќ»я - ѕ–≈ƒ» ј“ adj
set_commas([], _, []) :- ! .
...
goal
	test_partc("мальчик и дождь  выгл€дел смотр€ мультик непри€тным и ветер дул", Ans).
